        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            <div class="mx-auto max-w-2xl ">
                <div class="text-center">
                    <h1 class="text-balance text-2xl font-semibold tracking-tight text-gray-900 sm:text-7xl">Sign up for
                        ThinkThonk
                    </h1>
                    <div class="flex flex-col items-center justify-center">
                        <!-- Description -->
                        <p class="text-center text-gray-600 mb-6 pt-8">
                            Create your profile, follow other accounts, make your own videos, and more.
                        </p>
                        ...
                        <div class="space-y-4">
                            ...
                            <button
                                class="flex relative items-start justify-start w-full px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg shadow-sm hover:bg-gray-100">
                            ...
                            <button
                                class="flex items-start relative justify-start w-full px-10 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg shadow-sm hover:bg-gray-100">
                                <div class="absolute left-0 ml-2">
                                    <svg height="25px" width="25px" version="1.1" id="Layer_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        viewBox="0 0 291.319 291.319" xml:space="preserve" fill="#000000">
